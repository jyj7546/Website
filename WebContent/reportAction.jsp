...
<%
	...
	if (reportTitle == null | reportTitle.equals("") | reportTitle.equals("null") | 
			reportContent == null | reportContent.equals("") | reportContent.equals("null")) {
	...
	String to = "wjsdudwns429@naver.com";
